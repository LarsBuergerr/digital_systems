...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"Z:\digitalesysteme\digitalesysteme_bence\aufgabe1\synthesis\aufgabe1.edn"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {Z:\digitalesysteme\digitalesysteme_bence\aufgabe1\designer\aufgabe1} \
    -design aufgabe1 \
    -fam SmartFusion2 \
    -die PA4M500 \
    -pkg tq144 \
